...
if (ENABLE_MEMORY_COVERAGE)
    ...
    if (DEFINED ENV{MSAN_IGNORELIST_FILE} AND EXISTS "$ENV{MSAN_IGNORELIST_FILE}")
        message(STATUS "MSAN ignorelist: $ENV{MSAN_IGNORELIST_FILE}")
        if (CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "12.0")
            set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fsanitize-ignorelist=$ENV{MSAN_IGNORELIST_FILE}")
            set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -fsanitize-ignorelist=$ENV{MSAN_IGNORELIST_FILE}")
        else()
            set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fsanitize-blacklist=$ENV{MSAN_IGNORELIST_FILE}")
            set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -fsanitize-blacklist=$ENV{MSAN_IGNORELIST_FILE}")
        endif()
    endif()
endif()
