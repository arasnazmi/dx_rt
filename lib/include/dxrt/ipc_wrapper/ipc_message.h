...
namespace dxrt
{
    ...
    enum class REQUEST_CODE : uint32_t {
        ...
        STOPPED_DMA_TO_WAIT_RECOVERY = 911,
        CLOSE = 1001
    };
    ...
    enum class RESPONSE_CODE : uint32_t {
        ...
        THROTTLE_EVENT = 902,
        NOTIFY_RECOVERY_STOP_DMA = 910,
        NOTIFY_RECOVERY_END_RESUME_DMA = 912,
        NOTIFY_RECOVERY_FAILED_DMA = 914,
        CLOSE = 1001,
...
#pragma pack(pop)
    ...
    inline DXRT_API std::string _s(dxrt::REQUEST_CODE c)
    {
        static const std::map<dxrt::REQUEST_CODE, std::string> m = {
            ...
            {dxrt::REQUEST_CODE::STOPPED_DMA_TO_WAIT_RECOVERY, "STOPPED_DMA_TO_WAIT_RECOVERY"},
    ...
    inline DXRT_API std::string _s(dxrt::RESPONSE_CODE c)
    {
        static const std::map<dxrt::RESPONSE_CODE, std::string> m = {
            ...
            {dxrt::RESPONSE_CODE::NOTIFY_RECOVERY_STOP_DMA, "NOTIFY_RECOVERY_STOP_DMA"},
            {dxrt::RESPONSE_CODE::NOTIFY_RECOVERY_END_RESUME_DMA, "NOTIFY_RECOVERY_END_RESUME_DMA"},
